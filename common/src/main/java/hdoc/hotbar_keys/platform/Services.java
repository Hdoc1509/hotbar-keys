...
import hdoc.hotbar_keys.Constants;
...
public class Services {
    ...
    // service must be defined manually by including a text file in META-INF/services named with the
    // fully qualified class name of the service. Inside the file you should write the fully
    // qualified class name of the implementation to load for the platform. For example our file on
    // Forge points to ForgePlatformHelper while Fabric points to FabricPlatformHelper.
